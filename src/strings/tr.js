...
const tr = {
  ...
  trustTeam: {
    ...
    modal: {
      ...
      next: 'Devam',
      back: 'Geri',
      generate: 'Davet Oluştur',
      linkReady: 'Davet linkini paylaş',
      linkHint: 'Bu linke tıklayıp şifre belirleyerek katılabilirler.',
      codeBackupLabel: 'Yedek kod',
  ...
  join: {
    title: '1729\'a katıl',
    subtitle: 'Davet edildin. Şifreni belirle, içeri gir.',
    invitedAs: 'Davet edilen e-posta',
    passwordLabel: 'Şifre belirle',
    passwordPlaceholder: '••••••••',
    cta: 'Katıl',
    joining: 'Katılıyorsun',
    invalidInvite: 'Bu davet geçersiz ya da daha önce kullanılmış.',
    confirmEmail: 'Hesabın oluşturuldu. E-postana bir doğrulama linki gönderdik — tıkla, sonra giriş yap.',
