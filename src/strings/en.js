...
const en = {
  ...
  trustTeam: {
    ...
    modal: {
      ...
      linkReady: 'Share the invite link',
      linkHint: 'They join by opening this link and setting a password.',
      codeBackupLabel: 'Backup code',
      copyLink: 'Copy link',
      copy: 'Copy',
      copied: 'Copied!',
      close: 'Done',
  ...
  join: {
    title: 'Join 1729',
    subtitle: 'You\'ve been invited. Set your password to come in.',
    invitedAs: 'Invited email',
    passwordLabel: 'Set a password',
    passwordPlaceholder: '••••••••',
    cta: 'Join',
    joining: 'Joining',
    invalidInvite: 'This invite is invalid or has already been used.',
    confirmEmail: 'Your account was created. We sent a confirmation link to your email — click it, then log in.',
